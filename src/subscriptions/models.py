...
class Subscription(models.Model):
    ...
    features = models.TextField(help_text="Features for pricing, seperted by new line", null=True, blank=True)
...
class UserSubscription(models.Model):
    ...
    def billing_cycle_anchor(self):
        """
        Optional delay to start of new stripe subscription. Would need more logic to implement
        """
